...
- [[SDD/SDD规范驱动开发新范式：软件工程的未来变革与落地实践|SDD 新范式：未来变革与落地实践]] *(腾讯云)*
- [[SDD/规范驱动开发（SDD）：用 AI 写生产级代码的完整指南|用 AI 写生产级代码的完整指南]] *(腾讯云)*
- [[../../800 - 原文存档/Spec Driven Development When Architecture Becomes Executable|When Architecture Becomes Executable]] *(InfoQ · 英文)*
